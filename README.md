...
- [ms3-crew-dictionary](#ms3-crew-dictionary)
- [UX](#ux)
  * [General](#general)
...
- [CRUD - Create, Read, Update and Delete](#crud---create--read--update-and-delete)
  * [Create](#create)
    + [Submit new word](#submit-new-word)
    + [Register new user](#register-new-user)
  * [Read](#read)
    + [Display words from the database](#display-words-from-the-database)
    + [Search](#search-1)
    + [Search by "submitted by"](#search-by--submitted-by-)
  * [Update](#update)
    + [Edit words](#edit-words)
    + [Edit user types](#edit-user-types)
  * [Delete](#delete)
    + [Reject words](#reject-words)
    + [Delete word](#delete-word)
- [Mongo DB Databse Structure](#mongo-db-databse-structure)
...
* [Check if authenticated user](https://github.com/NgiapPuoyKoh/ai-chat-annotator/blob/7b37842579f8d1783de8d11be544f9790b248f05/app.py#L534) - Helper function taken from project ai-chat-annotator by NgiapPuoyKoh
* [Is object ID valid](https://github.com/NgiapPuoyKoh/ai-chat-annotator/blob/7b37842579f8d1783de8d11be544f9790b248f05/app.py#L528) - Helper function taken from project ai-chat-annotator by NgiapPuoyKoh
